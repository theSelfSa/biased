    ...
    <div className="space-y-6">
        ...
        {session?.user ? (
          <Card className="space-y-4">
            ...
            <CardDescription className="leading-7">
              Auth is live. You can create a fresh business workspace or keep
              using the seeded pharmacy demo while the rest of the platform
              comes online.
            </CardDescription>
          </Card>
        ) : (
      ...
      <section className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
        <Card>
          <CardHeader className="flex-col items-start">
            ...
            <CardDescription>
              A quick read on whether growth is translating into healthy cash
              and margin.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="space-y-4">
          ...
          {brief.generatedAt ? (
            <p className="text-xs uppercase tracking-[0.18em] text-[var(--color-brand-600)]">
              Generated {brief.generatedAt.slice(0, 19).replace("T", " ")}
            </p>
          ) : null}
      ...
      <section className="grid gap-5 xl:grid-cols-3">
        <div className="xl:col-span-2">
          <RecurringObligationsManager
            initialObligations={dashboard.obligations}
          />
        </div>
